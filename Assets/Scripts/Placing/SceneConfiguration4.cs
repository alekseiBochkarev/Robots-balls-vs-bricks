public class SceneConfiguration4 : SceneConfiguration
{
    void Awake()
    {
        _objectGamePositions = new[]
        {
            ...
            new ObjectGamePosition("enemies/Brick3", 0, 5, 8), 
            new ObjectGamePosition("enemies/Brick3", 1, 5, 8),
            new ObjectGamePosition("enemies/Brick3", 2, 5, 8), 
            new ObjectGamePosition("enemies/Brick3", 3, 5, 8), 
            new ObjectGamePosition("enemies/Brick3", 8, 5, 8), 
            new ObjectGamePosition("enemies/Brick3", 9, 5, 8),
            new ObjectGamePosition("enemies/Brick3", 10, 5, 8), 
            new ObjectGamePosition("enemies/Brick3", 11, 5, 8), 
